...
MESH_SIZE_QUAD = 0.03
MESH_SIZE_TRI = 0.04
JOB_NAME = "MSZ-"+str(MESH_SIZE_QUAD).replace(".","")+time.strftime("_%d-%m-%Y-%H%M",time.localtime())+"-3D"
...
mdb.models[MODEL_NAME].Part(dimensionality=THREE_D, name='plate', type=DEFORMABLE_BODY)
mdb.models[MODEL_NAME].parts['plate'].BaseSolidExtrude(depth=2.99, sketch=mdb.models[MODEL_NAME].sketches['__profile__'])
...
for _stp in STEP_FILES:
	...
	mdb.models[MODEL_NAME].Part(dimensionality=THREE_D, name=_stp[7::], type=ANALYTIC_RIGID_SURFACE)
	mdb.models[MODEL_NAME].parts[_stp[7::]].AnalyticRigidSurfExtrude(depth=2.99, sketch=mdb.models[MODEL_NAME].sketches['__profile__'])
	#mdb.models[MODEL_NAME].parts[_stp[7::]].AnalyticRigidSurf2DPlanar(sketch=mdb.models[MODEL_NAME].sketches['__profile__'])
	del mdb.models[MODEL_NAME].sketches['__profile__']

# Plate partition ========================================================================
mdb.models[MODEL_NAME].parts['plate'].PartitionCellByPatchNCorners(cell=
    mdb.models[MODEL_NAME].parts['plate'].cells[0], cornerPoints=(
    mdb.models[MODEL_NAME].parts['plate'].vertices[4], 
    mdb.models[MODEL_NAME].parts['plate'].vertices[10], 
    mdb.models[MODEL_NAME].parts['plate'].vertices[11], 
    mdb.models[MODEL_NAME].parts['plate'].vertices[5]))
mdb.models[MODEL_NAME].parts['plate'].PartitionCellByPlaneNormalToEdge(cells=
    mdb.models[MODEL_NAME].parts['plate'].cells.getSequenceFromMask(('[#2 ]', 
    ), ), edge=mdb.models[MODEL_NAME].parts['plate'].edges[10], point=
    mdb.models[MODEL_NAME].parts['plate'].vertices[9])
mdb.models[MODEL_NAME].parts['plate'].PartitionCellByPlaneNormalToEdge(cells=
    mdb.models[MODEL_NAME].parts['plate'].cells.getSequenceFromMask(('[#1 ]', 
    ), ), edge=mdb.models[MODEL_NAME].parts['plate'].edges[17], point=
    mdb.models[MODEL_NAME].parts['plate'].vertices[11])

# Surfaces ===============================================================================
mdb.models[MODEL_NAME].parts['lower_02'].Surface(name='Surf-1', side2Faces=
    mdb.models[MODEL_NAME].parts['lower_02'].faces.getSequenceFromMask((
    '[#7ffff ]', ), ))
mdb.models[MODEL_NAME].parts['lower_03'].Surface(name='Surf-1', side2Faces=
    mdb.models[MODEL_NAME].parts['lower_03'].faces.getSequenceFromMask((
    '[#1f ]', ), ))
mdb.models[MODEL_NAME].parts['lower_left_01'].Surface(name='Surf-1', 
    side2Faces=
    mdb.models[MODEL_NAME].parts['lower_left_01'].faces.getSequenceFromMask((
    '[#1f ]', ), ))
mdb.models[MODEL_NAME].parts['lower_right_01'].Surface(name='Surf-1', 
    side2Faces=
    mdb.models[MODEL_NAME].parts['lower_right_01'].faces.getSequenceFromMask((
    '[#1f ]', ), ))
mdb.models[MODEL_NAME].parts['pisador'].Surface(name='Surf-1', side2Faces=
    mdb.models[MODEL_NAME].parts['pisador'].faces.getSequenceFromMask(('[#1 ]', 
    ), ))
mdb.models[MODEL_NAME].parts['plate'].Surface(name='Surf-1', side1Faces=
    mdb.models[MODEL_NAME].parts['plate'].faces.getSequenceFromMask((
    '[#7fe6a ]', ), ))
mdb.models[MODEL_NAME].parts['upper_03'].Surface(name='Surf-1', side2Faces=
    mdb.models[MODEL_NAME].parts['upper_03'].faces.getSequenceFromMask((
    '[#1f ]', ), ))
mdb.models[MODEL_NAME].parts['upper_left_01'].Surface(name='Surf-1', 
    side2Faces=
    mdb.models[MODEL_NAME].parts['upper_left_01'].faces.getSequenceFromMask((
    '[#7 ]', ), ))
mdb.models[MODEL_NAME].parts['upper_left_02'].Surface(name='Surf-1', 
    side2Faces=
    mdb.models[MODEL_NAME].parts['upper_left_02'].faces.getSequenceFromMask((
    '[#f ]', ), ))
mdb.models[MODEL_NAME].parts['upper_right_01'].Surface(name='Surf-1', 
    side2Faces=
    mdb.models[MODEL_NAME].parts['upper_right_01'].faces.getSequenceFromMask((
    '[#7 ]', ), ))
mdb.models[MODEL_NAME].parts['upper_right_02'].Surface(name='Surf-1', 
    side2Faces=
    mdb.models[MODEL_NAME].parts['upper_right_02'].faces.getSequenceFromMask((
    '[#f ]', ), ))
...
mdb.models[MODEL_NAME].HomogeneousSolidSection(material='Acero 1018 US', name=
    'mp-section', thickness=None)
mdb.models[MODEL_NAME].parts['plate'].SectionAssignment(offset=0.0, 
    offsetField='', offsetType=MIDDLE_SURFACE, region=Region(
    cells=mdb.models[MODEL_NAME].parts['plate'].cells.getSequenceFromMask(
    mask=('[#f ]', ), )), sectionName='mp-section', thicknessAssignment=
    FROM_SECTION)
...
mdb.models[MODEL_NAME].RigidBody(name='Constraint-1', refPointRegion=Region(
    referencePoints=(
    mdb.models[MODEL_NAME].rootAssembly.instances['lower_02-1'].referencePoints[3], 
    )), surfaceRegion=
...
mdb.models[MODEL_NAME].RigidBody(name='Constraint-2', refPointRegion=Region(
    referencePoints=(
    mdb.models[MODEL_NAME].rootAssembly.instances['lower_02-2'].referencePoints[3], 
    )), surfaceRegion=
...
mdb.models[MODEL_NAME].RigidBody(name='Constraint-3', refPointRegion=Region(
    referencePoints=(
    mdb.models[MODEL_NAME].rootAssembly.instances['lower_03-1'].referencePoints[3], 
    )), surfaceRegion=
...
mdb.models[MODEL_NAME].RigidBody(name='Constraint-4', refPointRegion=Region(
    referencePoints=(
    mdb.models[MODEL_NAME].rootAssembly.instances['lower_left_01-1'].referencePoints[3], 
    )), surfaceRegion=
...
mdb.models[MODEL_NAME].RigidBody(name='Constraint-5', refPointRegion=Region(
    referencePoints=(
    mdb.models[MODEL_NAME].rootAssembly.instances['lower_left_01-2'].referencePoints[3], 
    )), surfaceRegion=
...
mdb.models[MODEL_NAME].RigidBody(name='Constraint-6', refPointRegion=Region(
    referencePoints=(
    mdb.models[MODEL_NAME].rootAssembly.instances['lower_right_01-1'].referencePoints[3], 
    )), surfaceRegion=
...
mdb.models[MODEL_NAME].RigidBody(name='Constraint-7', refPointRegion=Region(
    referencePoints=(
    mdb.models[MODEL_NAME].rootAssembly.instances['lower_right_01-2'].referencePoints[3], 
    )), surfaceRegion=
...
mdb.models[MODEL_NAME].RigidBody(name='Constraint-8', refPointRegion=Region(
    referencePoints=(
    mdb.models[MODEL_NAME].rootAssembly.instances['pisador-1'].referencePoints[3], 
    )), surfaceRegion=
...
mdb.models[MODEL_NAME].RigidBody(name='Constraint-9', refPointRegion=Region(
    referencePoints=(
    mdb.models[MODEL_NAME].rootAssembly.instances['upper_03-1'].referencePoints[3], 
    )), surfaceRegion=
...
mdb.models[MODEL_NAME].RigidBody(name='Constraint-10', refPointRegion=Region(
    referencePoints=(
    mdb.models[MODEL_NAME].rootAssembly.instances['upper_left_01-1'].referencePoints[3], 
    )), surfaceRegion=
...
mdb.models[MODEL_NAME].RigidBody(name='Constraint-11', refPointRegion=Region(
    referencePoints=(
    mdb.models[MODEL_NAME].rootAssembly.instances['upper_left_02-1'].referencePoints[3], 
    )), surfaceRegion=
...
mdb.models[MODEL_NAME].RigidBody(name='Constraint-12', refPointRegion=Region(
    referencePoints=(
    mdb.models[MODEL_NAME].rootAssembly.instances['upper_right_01-1'].referencePoints[3], 
    )), surfaceRegion=
...
mdb.models[MODEL_NAME].RigidBody(name='Constraint-13', refPointRegion=Region(
    referencePoints=(
    mdb.models[MODEL_NAME].rootAssembly.instances['upper_right_02-1'].referencePoints[3], 
    )), surfaceRegion=
...
mdb.models[MODEL_NAME].DisplacementBC(amplitude='Amp-1', createStepName=
    ...
    mdb.models[MODEL_NAME].rootAssembly.instances['upper_left_01-1'].referencePoints[3], 
    mdb.models[MODEL_NAME].rootAssembly.instances['upper_right_01-1'].referencePoints[3], 
    )), u1=0.0, u2=-(YDISP), u3=0.0, ur1=0.0, ur2=0.0, ur3=0.0)
...
mdb.models[MODEL_NAME].DisplacementBC(amplitude='Amp-1', createStepName=
    ...
    mdb.models[MODEL_NAME].rootAssembly.instances['upper_left_02-1'].referencePoints[3], 
    mdb.models[MODEL_NAME].rootAssembly.instances['upper_right_02-1'].referencePoints[3], 
    )), u1=0.0, u2=0, u3=0.0, ur1=0.0, ur2=0.0, ur3=0.0)
...
mdb.models[MODEL_NAME].boundaryConditions['BC-Upper-01'].setValuesInStep(stepName=DYNEXP_STEPS[3], u2=0.0)
...
mdb.models[MODEL_NAME].boundaryConditions['BC-Upper-02'].setValuesInStep(stepName=DYNEXP_STEPS[5], u2=0.0)
...
mdb.models[MODEL_NAME].DisplacementBC(amplitude=UNSET, createStepName=
    ...
    mask=('[#2 ]', ), )), u1=0.0, u2=UNSET, u3=UNSET, ur1=UNSET, ur2=UNSET, ur3=UNSET)
...
mdb.models[MODEL_NAME].parts['plate'].seedEdgeBySize(constraint=FINER, 
    ...
    mdb.models[MODEL_NAME].parts['plate'].edges.getSequenceFromMask((
    '[#12a0102a ]', ), ), minSizeFactor=0.1, size=MESH_SIZE_QUAD)
mdb.models[MODEL_NAME].parts['plate'].seedEdgeBySize(constraint=FINER, 
    deviationFactor=0.1, edges=
    mdb.models[MODEL_NAME].parts['plate'].edges.getSequenceFromMask((
    '[#20108400 ]', ), ), minSizeFactor=0.1, size=MESH_SIZE_TRI)
mdb.models[MODEL_NAME].parts['plate'].generateMesh()

# HOut  ==================================================================================
mdb.models['3D-MODEL'].HistoryOutputRequest(createStepName='Step-01-Down', 
    interactions=('INT-upper_left_01-1', ), name='F01', rebar=EXCLUDE, 
    sectionPoints=DEFAULT, timeInterval=0.0172, variables=('CFNM', ))
mdb.models['3D-MODEL'].HistoryOutputRequest(createStepName='Step-01-Down', 
    interactions=('INT-upper_left_02-1', ), name='F02', rebar=EXCLUDE, 
    sectionPoints=DEFAULT, timeInterval=0.0172, variables=('CFNM', ))
mdb.models['3D-MODEL'].HistoryOutputRequest(createStepName='Step-01-Down', 
    interactions=('INT-upper_03-1', ), name='F03', rebar=EXCLUDE, 
    sectionPoints=DEFAULT, timeInterval=0.0172, variables=('CFNM', ))
